        ...
        <div>
            ...
            <div className=" h-full bg-white  pt-24 sm:tp-26 md:36">
                <div className="container mx-auto px-2 sm:px-4 md:px-10  lg:px-20">
                    <motion.h1  initial={{y:-200}}  animate={{y:0}} className="py-2  text-1xl sm:text-3xl  font-semibold sm:font-light">Empezar siempre es un reto, pero no te preocupes nuestro equipo esta listo para ayudarte a crear tu tienda online conectado a tu Whatsapp</motion.h1>
                </div>
